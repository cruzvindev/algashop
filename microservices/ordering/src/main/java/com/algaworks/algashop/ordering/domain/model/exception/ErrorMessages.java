...
public class ErrorMessages {
    ...
    public static final String VALIDATION_ERROR_LOYALTY_POINTS_CANNOT_BE_NEGATIVE = "Loyalty value cannot be negative";
    public static final String VALIDATION_ERROR_LOYALTY_POINTS_CANNOT_BE_ZERO = "Loyalty value cannot be zero";
    ...
    public static final String ERROR_ORDER_DOES_NOT_CONTAIN_ITEM = "Order %s does not contain order item %s";
